    ...
    return(
        <div>
            <div className="content" style={{ marginBottom:'-15px'}}>
                ...
                <p>Silakan merujuk pada <a href="/">Peraturan Konten</a> dan <a href="/">Syarat dan Ketentuan</a> kami dan beri tahu kami mengapa menurut Anda konten yang Anda laporkan melanggar pedoman ini:</p>
            </div>
            <div>
